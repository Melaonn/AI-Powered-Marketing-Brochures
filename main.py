...
# System prompt for link filtering
link_system_prompt = """
...
def get_brochure_user_prompt(company_name, url):
    ...
    user_prompt = user_prompt[:5000]  # Truncate to 5000 chars
    return user_prompt

# Generate and display the brochure
...
# Stream the brochure with live display
